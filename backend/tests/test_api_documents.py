...
class TestDocumentsAPI:
    ...
    def test_list_documents(self, client, mock_mongodb, sample_document):
        ...
        mock_cursor.skip.return_value.limit.return_value.sort.return_value.to_list = (
    ...
    def test_get_document_content_not_processed(
        self, client, mock_mongodb, sample_document
    ):
    ...
    def test_delete_document(self, client, mock_mongodb, sample_document):
        ...
        with patch("os.path.exists", return_value=True):
            with patch("os.remove"):
                with patch(
                    "app.api.routes.documents.remove_document", new_callable=AsyncMock
                ):
    ...
    def test_get_timestamps(self, client, mock_mongodb, sample_audio_document):
        ...
        response = client.get(
            f"/api/documents/{sample_audio_document['_id']}/timestamps"
        )
    ...
    def test_get_timestamps_not_processed(
        self, client, mock_mongodb, sample_audio_document
    ):
