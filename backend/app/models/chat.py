...
class ChatRequest(BaseModel):
    ...
    include_timestamps: bool = Field(default=True, description="Include timestamp references for media")
...
class ChatResponse(BaseModel):
    ...
    timestamps: List[dict] = Field(default_factory=list, description="Relevant timestamps")
